...
const translations = {
  en: {
    ...
    'login.footer.text': 'New to Snapflix?',
    ...
    'subscription.management.subtitle': 'Manage your Snapflix subscription and billing',
    ...
    'homepage.videos.subtitle': 'Watch gameplay and reviews',
  ...
  zh: {
    ...
    'subscription.management.subtitle': '管理您的 Snapflix 订阅和账单',
    ...
    'homepage.videos.subtitle': '观看游戏玩法和评论',
  ...
  fr: {
    ...
    'login.footer.text': 'Nouveau sur Snapflix ?',
    ...
    'subscription.management.subtitle': 'Gérez votre abonnement Snapflix et la facturation',
    ...
    'homepage.videos.subtitle': 'Regardez les gameplay et avis',
